...
@synthesize notifications, previousPercent;
@synthesize settings;
...
//    advancedSubmenuItem.state = self.settings.advancedMode;
...
////    [[self.statusItem.menu itemWithTag:kBTRMenuPowerSourceAdvanced] setHidden:self.settings.advancedMode];
////    [[self.statusItem.menu itemWithTag:kBTRMenuNotification] setHidden:self.settings.advancedMode];
////    
////    NSMenuItem *item = (NSMenuItem*)sender;
////    item.state = !item.state;
////    self.settings.advancedMode = item.state;
////    
////    [self updateStatusItem];
//}
//
